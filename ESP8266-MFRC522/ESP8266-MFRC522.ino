...
void handleRoot() {
  ...
  s += "CARD DATA: ";
  s +=  "<img src=\"http://yyliao1.github.io/image/rfidreader.gif\" /><p>";
  s += "<script type=\"text/javascript\" src=\"http://code.jquery.com/jquery-1.11.0.min.js\"></script>";
  s += "<script type=\"text/javascript\">";
  s += "$(document).ready(function(){";
  s += "$('#button').click(function(e) {";
  s += "var inputvalue = $(\"#input\").val();";
  s += "window.location.replace(\"rfidwrite?YY=\"+inputvalue);";
  s += "});";
  s += "}); </script>";
   s += "<p><input type=\"text\" value=\"\" id=\"input\"> ";
  s += "<p><a href=\"\\rfidread\"><button>Read the card</button></a>";
  s += "<button type=\"button\" id=\"button\">Write</button>";
  s += "</html>\n";
