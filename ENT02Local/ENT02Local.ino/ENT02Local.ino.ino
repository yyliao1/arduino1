...
const char* host = "ent02";
IPAddress ip(192, 168, 1, 112); //Node static IP
IPAddress gateway(192, 168, 1, 1);
IPAddress subnet(255, 255, 255, 0);
const char* entity = "ENT02";
...
IRsend irsend(5); //an IR emitter led is connected to GPIO pin 3
        ...
        case 'G': // GPIO
          {
            ...
            String gpi = "http://";
            gpi += serverIP;
            gpi += "/gpioUpdate01.php?entity=ENT02&gpiono=";
            gpi += pin;
            gpi += "&measure=";
            gpi += value;
            // Serial.println(gpi);
